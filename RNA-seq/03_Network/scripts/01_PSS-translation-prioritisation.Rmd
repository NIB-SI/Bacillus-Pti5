...
url = "https://raw.githubusercontent.com/NIB-SI/DiNAR/master/TranslationTables/rbb_ath-vs-stuGFF_5_rbb-translation_filtered-long.txt"
RBBnew.GFFmerged.long = read.table(url,
                     sep = "\t", 
                     fill = TRUE, 
                     header = TRUE,
...
fn = 'cytoscape_prioritised_PSS.txt'
...
fpo = file.path('..', 'output', 'DiNAR', 'dummyFilesForDiNAR_PSS')
