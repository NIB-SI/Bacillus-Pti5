...
pdf(file.path(fpo, paste0(gsub('\\..*', '', fn1), '_1.pdf')), width = 6, height = 6)  # Open PDF device
...
# Save the heatmap to a PDF file
pdf(file.path(fpo, paste0(gsub('\\..*', '', fn1), '_2.pdf')), width = 6, height = 6)  # Open PDF device
grid::grid.draw(p$gtable)                  # Explicitly draw the heatmap
dev.off()                                  # Close the PDF device
...
# Save the heatmap to a PDF file
pdf(file.path(fpo, paste0( gsub('\\..*', '', fn2), '_1.pdf')), width = 6, height = 6)  # Open PDF device
grid::grid.draw(p$gtable)                  # Explicitly draw the heatmap
dev.off()                                  # Close the PDF device
...
# Save the heatmap to a PDF file
pdf(file.path(fpo, paste0(gsub('\\..*', '', fn2), '_2.pdf')), width = 6, height = 6)  # Open PDF device
grid::grid.draw(p$gtable)                  # Explicitly draw the heatmap
dev.off()                                  # Close the PDF device
