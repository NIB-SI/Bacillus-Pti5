...
my_dir = file.path("..", "reports", "ConditionedMedium")
if (!dir.exists(my_dir)) {
  dir.create(my_dir)
}
fr = file.path('..', 'output',  'ConditionedMedium_stat.txt')
file.create(fr)
...
sheet_name = grep("ConditionedMedium", sheet_names, value = TRUE)
...
myorder = c("StRBOHD", "StCPI8", "StCAB", "StBGLU2", "StHSP70", "StPti5", "St13-LOX")
...
ggsave(
  filename = file.path(my_dir, "roots_1.svg"),
  plot = result$plot1,
  device = svg,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "roots_2.svg"),
  plot = result$plot2,
  device = svg,
  path = NULL,
  scale = 1,
