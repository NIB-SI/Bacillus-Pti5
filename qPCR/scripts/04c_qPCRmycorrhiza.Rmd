...
fr = file.path('..', 'output',  'qPCRmycorrhiza_perm_stat.txt')
file.create(fr)
...
process_data <- function(df, groupvars, measurevar, scale_treatment = "noninoculated") {
  ...
  Rywal = df.scaled %>% dplyr::filter(Genotype == "Rywal")
  shPTI5RywalL6 = df.scaled %>% dplyr::filter(Genotype == "shPTI5-Rywal L6")
  shPTI5RywalL2 = df.scaled %>% dplyr::filter(Genotype == "shPTI5-Rywal L2")
  
  return(list(
    Rywal = Rywal,
    shPTI5RywalL6 = shPTI5RywalL6,
    shPTI5RywalL2 = shPTI5RywalL2
  ))
}
...
Rywal = process_data(df, groupvars, measurevar, scale_treatment = "noninoculated")$Rywal
shPTI5RywalL6 = process_data(df, groupvars, measurevar, scale_treatment = "noninoculated")$shPTI5RywalL6
shPTI5RywalL2 = process_data(df, groupvars, measurevar, scale_treatment = "noninoculated")$shPTI5RywalL2



cat("AMF", file = fr, append = TRUE, sep = "\n")
cat("", file = fr, append = TRUE, sep = "\n")
...
result = test_and_plot(data_long_raw = Rywal
                       , myorder = myorder
                       , pal = pal
                       , what = "Rywal"
...
ggsave(
  filename = file.path(my_dir, "AMF-addOn_Rywal_1.pdf"),
  plot = result$plot1,
  device = pdf,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "AMF-addOn_Rywal_2.pdf"),
  plot = result$plot2,
  device = pdf,
  path = NULL,
  scale = 1,
...
max_per_transcript = shPTI5RywalL6 %>%
  dplyr::group_by(transcript) %>%
  dplyr::summarise(max_scaled = max(scaled, na.rm = TRUE), .groups = "drop")
group2_names = setdiff(max_per_transcript$transcript, group1_names)
y_scales1 = build_y_scales_for(group1_names, max_per_transcript)
...
result = test_and_plot(data_long_raw = shPTI5RywalL6
                       , myorder = myorder
                       , pal = pal
                       , what = "shPTI5-Rywal L6"
                       , plot_gene_expression_func = plot_gene_expression
                       , groupvars = c("Treatment", "transcript")
                       , y_scales1
                       , y_scales2
...
ggsave(
  filename = file.path(my_dir, "AMF-addOn_shPTI5RywalL6_1.pdf"),
  plot = result$plot1,
  device = pdf,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "AMF-addOn_shPTI5RywalL6_2.pdf"),
  plot = result$plot2,
  device = pdf,
  path = NULL,
  scale = 1,
...
max_per_transcript = shPTI5RywalL2 %>%
  dplyr::group_by(transcript) %>%
  dplyr::summarise(max_scaled = max(scaled, na.rm = TRUE), .groups = "drop")
group2_names = setdiff(max_per_transcript$transcript, group1_names)
y_scales1 = build_y_scales_for(group1_names, max_per_transcript)
...
result = test_and_plot(data_long_raw = shPTI5RywalL2
                       , myorder = myorder
                       , pal = pal
                       , what = "shPTI5-Rywal L2"
                       , plot_gene_expression_func = plot_gene_expression
                       , groupvars = c("Treatment", "transcript")
                       , y_scales1
                       , y_scales2
...
ggsave(
  filename = file.path(my_dir, "AMF-addOn_shPTI5RywalL2_1.pdf"),
  plot = result$plot1,
  device = pdf,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "AMF-addOn_shPTI5RywalL2_2.pdf"),
  plot = result$plot2,
  device = pdf,
  path = NULL,
  scale = 1,
