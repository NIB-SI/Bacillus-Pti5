...
my_dir = file.path("..", "reports", "AMF_colonisation")
...
fp = file.path('..', 'input')
fn = 'AMFcolonisation.xlsx'

df = openxlsx::read.xlsx(file.path(fp, fn), sheet = 'raw data 3,4wpi')
...
- Sidak adjustment for controlling family-wise error rate
