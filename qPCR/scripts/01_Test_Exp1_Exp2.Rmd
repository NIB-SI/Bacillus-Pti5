...
sheet_name = grep("Test", sheet_names, value = TRUE)
...
my_dir = file.path("..", "reports", "Test")
if (!dir.exists(my_dir)) {
  dir.create(my_dir)
}
fr = file.path('..', 'output',  'Test_stat.txt')
file.create(fr)
...
# override for LOX and PTI5
y_scales1 = list(
  transcript == "St13-LOX" ~ ggplot2::scale_y_continuous(
    limits = c(0, 11),
    breaks = c(0, 2, 4, 6, 8, 10)
  ),
  transcript == "StPti5" ~ ggplot2::scale_y_continuous(
    limits = c(0, 11),
    breaks = c(0, 2, 4, 6, 8, 10)
  )
)
...
ggsave(
  filename = file.path(my_dir, "Test_shoots.216_1.svg"),
  plot = result$plot1,
  device = "svg",
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "Test_shoots.216_2.svg"),
  plot = result$plot2,
  device = svg,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "Test_roots.216_1.svg"),
  plot = result$plot1,
  device = svg,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "Test_roots.216_2.svg"),
  plot = result$plot2,
  device = svg,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "Test_shoots.218_1.svg"),
  plot = result$plot1,
  device = svg,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "Test_shoots.218_2.svg"),
  plot = result$plot2,
  device = svg,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "Test_roots.218_1.svg"),
  plot = result$plot1,
  device = svg,
  path = NULL,
  scale = 1,
...
ggsave(
  filename = file.path(my_dir, "Test_roots.218_2.svg"),
  plot = result$plot2,
  device = svg,
  path = NULL,
  scale = 1,
...
keep = c("magrittr", "ggplot2", "%!in%", "pal", "my_dir", "fr", "group1_names", "sheet_names")
all_objs = ls()
...
my_dir = file.path("..", "reports", "Experiment1")
if (!dir.exists(my_dir)) {
  dir.create(my_dir)
}
fr = file.path('..', 'output',  'Experiment1_stat.txt')
file.create(fr)
...
myorder = c("StBGLU2", "StHSP70", "StPti5", "St13-LOX")
...
run_analysis_for_time <- function(data
  ...
  ggsave(filename = file.path(my_dir, paste0("Exp1_shoots.", gsub(" ", "", time_point), "_1.svg")),
  ...
  ggsave(filename = file.path(my_dir, paste0("Exp1_shoots.", gsub(" ", "", time_point), "_2.svg")),
         plot = result_shoots$plot2, device = svg, width = 3, height = 8, units = "in", dpi = 900)
  ...
  ggsave(filename = file.path(my_dir, paste0("Exp1_roots.", gsub(" ", ".", time_point), "_1.svg")),
  ...
  ggsave(filename = file.path(my_dir, paste0("Exp1_roots.", gsub(" ", ".", time_point), "_2.svg")),
         plot = result_roots$plot2, device = svg, width = 3, height = 8, units = "in", dpi = 900)
...
my_dir = file.path("..", "reports", "Experiment2")
if (!dir.exists(my_dir)) {
  dir.create(my_dir)
}
fr = file.path('..', 'output',  'Experiment2_stat.txt')
file.create(fr)
...
run_analysis_for_time <- function(data
  ...
  ggsave(filename = file.path(my_dir, paste0("Exp2_roots.", gsub(" ", ".", time_point), "_1.pdf")),
         plot = result_roots$plot1, device = pdf, width = 3, height = 8, units = "in", dpi = 900)
  ggsave(filename = file.path(my_dir, paste0("Exp2_roots.", gsub(" ", ".", time_point), "_1.svg")),
         plot = result_roots$plot1, device = svg, width = 3, height = 8, units = "in", dpi = 900)
  
  ggsave(filename = file.path(my_dir, paste0("Exp2_roots.", gsub(" ", ".", time_point), "_2.pdf")),
         plot = result_roots$plot2, device = pdf, width = 3, height = 8, units = "in", dpi = 900)
  ggsave(filename = file.path(my_dir, paste0("Exp2_roots.", gsub(" ", ".", time_point), "_2.svg")),
         plot = result_roots$plot2, device = svg, width = 3, height = 8, units = "in", dpi = 900)
