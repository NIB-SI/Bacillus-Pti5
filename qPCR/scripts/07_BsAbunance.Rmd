...
inn = inn[grep('apex', inn$Tissue, invert = TRUE), ]
...
yrep = rstanarm::posterior_predict(model2)
...
# On average,  model explains about XY% of the variance in the binary outcome
...
fisher.test(table(inn$Genotype, inn$output), alternative = "greater") # one‑sided Fisher’s test
...
- parts (1st, 2nd, …) are repeated within plants (part is nested within plant)
...
bayesplot::mcmc_pairs(
  ...
  pars = c(
    ...
    "GenotypeshPTI5-Rywal L2:part4th"
  )
)


bayesplot::mcmc_trace(posterior, pars = c("GenotypeRywal","part4th",
                                          "GenotypeshPTI5-Rywal L2", "GenotypeshPTI5-Rywal L2:part4th"))
